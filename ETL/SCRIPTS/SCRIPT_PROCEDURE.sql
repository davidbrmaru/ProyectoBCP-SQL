...
--[CHAPTER_LEADER]
	INSERT INTO [dbo].[CHAPTER_LEADER] (ID_CHAPTER_AREA_LEADER,COD_MATRICULA,NOMBRES,APELLIDO_PATERNO,APELLIDO_MATERNO,FEC_INGRESO,USUARIO_INGRESA,FLG_ACTIVO)
